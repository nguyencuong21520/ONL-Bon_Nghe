...
let loadConversations = async (email)=>{
    ...
    let chat_email = document.getElementById("currentEmail")
    chat_email.innerHTML = currentEmail
    ...
    rederListFriends(conversation, currentEmail)
...
let form = document.getElementById("message_input")
form.onsubmit = (e)=>{
  e.preventDefault()
